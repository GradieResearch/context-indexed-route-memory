...
- Run ID: `exp14_validation_20260507_210649`
- Profile: `validation`
- Seeds: `(0, 1, 2, 3, 4)`
- World counts: `(4, 8)`
- Route lengths: `(4, 8)`
- Cue counts: `(1, 2, 4)`
- Corruption rates: `(0.0, 0.25, 0.5)`
- Metrics rows: `1440`
- SQLite DB: `runs\exp14_validation_20260507_210649.sqlite3`
...
At the hardest clean setting available in this run (worlds=8, route_length=8, cue_count=4):
...
- Shared no-context table seen-route composition accuracy: 0.1250.
...
- CIRM latent selector world-selection accuracy: 0.7063.
- CIRM latent selector seen-route composition accuracy: 0.7063.
...
- `analysis\exp14_validation_20260507_210649\plots\exp14_world_selection_vs_corruption.png`
- `analysis\exp14_validation_20260507_210649\plots\exp14_seen_composition_vs_corruption.png`
- `analysis\exp14_validation_20260507_210649\plots\exp14_suffix_composition_vs_corruption.png`
- `analysis\exp14_validation_20260507_210649\plots\exp14_margin_vs_corruption.png`
- `analysis\exp14_validation_20260507_210649\plots\exp14_cue_count_selection_sensitivity.png`
- `analysis\exp14_validation_20260507_210649\plots\exp14_cue_count_composition_sensitivity.png`
