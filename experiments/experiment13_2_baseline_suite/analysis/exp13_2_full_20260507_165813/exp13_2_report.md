...
- Routes per world: `24`
- Metrics rows: `15040`
- SQLite DB: `runs\exp13_2_full_20260507_165813.sqlite3`
...
- Shared no-context transition-table seen-route accuracy at the hardest tested setting: 0.0312; first-step context disambiguation accuracy: 0.0312. Suffix probes can be easier for this baseline because they start after the deliberately conflicting first step.
...
- `analysis\exp13_2_full_20260507_165813\plots\exp13_2_suffix_generalization_accuracy.png`
- `analysis\exp13_2_full_20260507_165813\plots\exp13_2_route_table_accuracy.png`
- `analysis\exp13_2_full_20260507_165813\plots\exp13_2_first_step_context_accuracy.png`
- `analysis\exp13_2_full_20260507_165813\plots\exp13_2_capacity_pressure.png`
